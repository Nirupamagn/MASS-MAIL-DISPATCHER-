...
function sendEmails() {
    var promise = new Promise(function(resolve, reject) {
      Email.send({
        ...
        Username: "aninirugn@gmail.com",
        Password: "BE8088DCCEBD49CF79EF5F5E4BF72A1F2BFB",
        To:  "aninirugn@gmail.com",
        From: "aninirugn@gmail.com",
    ...
    promise.then(
      function (message) {
        alert(Window.valNo + " mails have been sent successfully. Press OK to continue" );
        location.reload();
      },
      function (error) {
